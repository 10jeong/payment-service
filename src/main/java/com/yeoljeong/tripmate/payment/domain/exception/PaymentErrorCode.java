...
public enum PaymentErrorCode implements ErrorCode {
    ...
    ORDER_OWNER_MISMATCH(HttpStatus.FORBIDDEN, "주문자와 결제자가 일치하지 않습니다."),
    ORDER_NOT_PAYABLE(HttpStatus.BAD_REQUEST, "결제 가능한 상태가 아닙니다."),
    TOSS_RESPONSE_NOT_FOUND(HttpStatus.NOT_FOUND, "토스 승인 정보를 찾을 수 없습니다."),
    TOSS_PAYMENT_ERROR(HttpStatus.BAD_GATEWAY, "토스 서비스 에러입니다."),
    PAYMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "결제 정보를 찾을 수 없습니다."),
    PAYMENT_OWNER_MISMATCH(HttpStatus.FORBIDDEN, "결제자 정보가 다릅니다."),
    ...
    PAYMENT_CANCEL_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "환불 처리가 실패했습니다." );
